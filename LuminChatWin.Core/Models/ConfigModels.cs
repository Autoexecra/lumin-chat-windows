...
public sealed class AppSection
{
    ...
    public string ThemeId { get; set; } = "sandstone-study";
}

public sealed class PromptConfig
{
    [JsonPropertyName("system_prompt_template")]
    public string SystemPromptTemplate { get; set; } = string.Empty;

    [JsonPropertyName("user_prompt_template")]
    public string UserPromptTemplate { get; set; } = "{input}";

    [JsonPropertyName("prompt_library_dir")]
    public string PromptLibraryDir { get; set; } = "~/.lumin-chat-win/prompts";

    [JsonPropertyName("selected_system_prompt_file")]
    public string SelectedSystemPromptFile { get; set; } = string.Empty;
