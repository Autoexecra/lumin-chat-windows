...
public sealed class ChatAgent
{
    ...
    {
        EnsureSystemPrompt();
        var templatedUserInput = PromptTemplateService.ApplyUserPromptTemplate(_config, userInput);
        CurrentSession.Messages.Add(new PersistedChatMessage { Role = "user", Content = templatedUserInput });
